...
def generate_synthetic_batch(
    ...
    """
    Generate physically plausible (X, y) samples from FEATURE_RANGES
...
# Training loop
# ==================================================================
def train_pinn(training_run, progress_callback=None) -> dict:
    ...
    optimizer = torch.optim.Adam(
        net.parameters(), lr=float(training_run.learning_rate),
    )
